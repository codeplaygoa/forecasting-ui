...
export var barChartLabels: string[] = ["Qty1-2019", "Qty2-2019", "Qty3-2019", "Qty4-2019", "Qty1-2020", "Qty2-2020", "Qty3-2020", "Qty4-2020"];
export var barChartType = 'bar';
export var barChartLegend = true ;
export var barChartData: any[] = [
  { data: [35, 59, 80, 81, 56, 55, 40, 30], label: 'Volume' },
  { data: [28, 48, 40, 19, 86, 27, 90, 54], label: 'Forecast' }
];
...
export var barChartOptions1: any = {
  scaleShowVerticalLines: false,
  responsive: true,
  legend: { 
      display: true, 
...
export var barChartLabels1: string[] = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
export var barChartType1 = 'bar';
export var barChartLegend1 = true ;
export var barChartData1: any[] = [
  { data: [35, 59, 80, 81, 56, 55, 40, 30], label: '2019' },
  { data: [28, 48, 40, 19, 86, 27, 90, 54], label: '2020' },
  { data: [38, 58, 50, 29, 96, 37, 100, 64], label: '2021' }
];
export var barChartColors1: Array<any> = [
  {
    backgroundColor: '#4466f2',
    borderColor: "rgba(30, 166, 236, 0.8)",
    borderWidth: 1,
